...
public class Trip {
    ...
    public static ArrayList<Trip> fromJSONArray(){
        ...
        try{
            jsonArray.put(new JSONObject("{\"id\":\"1\", \"name\":\"Trip 1\", \"distance\":\"11.1 miles \", \"totalLength\": 12, \"bannerPhoto\": \"http://www-tc.pbs.org/food/files/2012/07/History-of-Ice-Cream-1.jpg\"}"));
            jsonArray.put(new JSONObject("{\"id\":\"2\", \"name\":\"Trip 2\", \"distance\":\"6.5 miles \", \"totalLength\": 1.5, \"bannerPhoto\": \"http://www-tc.pbs.org/food/files/2012/07/History-of-Ice-Cream-1.jpg\"}"));
            jsonArray.put(new JSONObject("{\"id\":\"3\", \"name\":\"Trip 3\", \"distance\":\"3.1 miles \", \"totalLength\": 21, \"bannerPhoto\": \"http://www-tc.pbs.org/food/files/2012/07/History-of-Ice-Cream-1.jpg\"}"));
            jsonArray.put(new JSONObject("{\"id\":\"4\", \"name\":\"Trip 4\", \"distance\":\"2 miles \", \"totalLength\": 3, \"bannerPhoto\": \"http://www-tc.pbs.org/food/files/2012/07/History-of-Ice-Cream-1.jpg\"}"));
